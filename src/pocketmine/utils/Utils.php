...
class Utils
{
     ...
     *
     *
     * @param string  $extra (optional) optional, additional data to identify the machine
     * @return UUID
     */
     ...
     *
     *
     * @param bool    $force (optional) default false, force IP check even when cached
     * @return string
     */
     ...
     * Other => other
     *
     * @param unknown $recalculate (optional)
     * @return string
     */
     ...
     *
     *
     * @param int     $length       (optional) default 16, Number of bytes to generate
     * @param bool    $secure       (optional) default true, Generate secure distilled bytes, slower
     * @param bool    $raw          (optional) default true, returns a binary string if true, or an hexadecimal one
     * @param string  $startEntropy (optional) default null, adds more initial entropy
