...
class CraftingManager{
	...
	public function __construct(){
		...
		$this->registerRecipe((new BigShapedRecipe(Item::get(Item::CHEST, 0, 1),
			...
			"X X",
			"XXX"
		))->setIngredient("X", Item::get(Item::WOODEN_PLANK, "", 8)));
		...
		$this->registerRecipe((new ShapedRecipe(Item::get(Item::TORCH, 0, 4),
			...
			" X ",
			" Y "
		))->setIngredient("X", Item::get(Item::COAL, 1, 1))->setIngredient("Y", Item::get(Item::STICK, 0, 1)));
		
		$this->registerRecipe((new ShapedRecipe(Item::get(Item::SUGAR, 0, 1),
			"X"
		))->setIngredient("X", Item::get(Item::SUGARCANE, 0, 1)));
		
		$this->registerRecipe((new ShapedRecipe(Item::get(Item::BED, 0, 1),
			"   ",
			"XXX",
			"YYY"
		))->setIngredient("X", Item::get(Item::WOOL, "", 3))->setIngredient("Y", Item::get(Item::WOODEN_PLANK, "", 3)));
			
		$this->registerRecipe((new ShapedRecipe(Item::get(Item::FENCE, 0, 3),
			"   ",
			"XYX",
			"XYX"
		))->setIngredient("X", Item::get(Item::WOODEN_PLANK, Planks::OAK, 4))->setIngredient("Y", Item::get(Item::STICK, 0, 2)));
		
		$this->registerRecipe((new ShapedRecipe(Item::get(Item::FENCE, Planks::SPRUCE, 3),
			"   ",
			"XYX",
			"XYX"
		))->setIngredient("X", Item::get(Item::WOODEN_PLANK, Planks::SPRUCE, 4))->setIngredient("Y", Item::get(Item::STICK, 0, 2)));
		
		$this->registerRecipe((new ShapedRecipe(Item::get(Item::FENCE, Planks::BIRCH, 3),
			"   ",
			"XYX",
			"XYX"
		))->setIngredient("X", Item::get(Item::WOODEN_PLANK, Planks::BIRCH, 4))->setIngredient("Y", Item::get(Item::STICK, 0, 2)));
		
		$this->registerRecipe((new ShapedRecipe(Item::get(Item::FENCE, Planks::JUNGLE, 3),
			"   ",
			"XYX",
			"XYX"
		))->setIngredient("X", Item::get(Item::WOODEN_PLANK, Planks::JUNGLE, 4))->setIngredient("Y", Item::get(Item::STICK, 0, 2)));
		
		$this->registerRecipe((new ShapedRecipe(Item::get(Item::FENCE, Planks::ACACIA, 3),
			"   ",
			"XYX",
			"XYX"
		))->setIngredient("X", Item::get(Item::WOODEN_PLANK, Planks::ACACIA, 4))->setIngredient("Y", Item::get(Item::STICK, 0, 2)));
		
		$this->registerRecipe((new ShapedRecipe(Item::get(Item::FENCE, Planks::DARK_OAK, 3),
			"   ",
			"XYX",
			"XYX"
		))->setIngredient("X", Item::get(Item::WOODEN_PLANK, Planks::DARK_OAK, 4))->setIngredient("Y", Item::get(Item::STICK, 0, 2)));
		
		
		$this->registerRecipe((new ShapedRecipe(Item::get(Item::FENCE_GATE, 0, 1),
			"   ",
			"XYX",
			"XYX"
		))->setIngredient("X", Item::get(Item::STICK, 0, 4))->setIngredient("Y", Item::get(Item::WOODEN_PLANK, Planks::OAK, 2)));
			
		$this->registerRecipe((new ShapedRecipe(Item::get(Item::FENCE_GATE_SPRUCE, 0, 1),
			"   ",
			"XYX",
			"XYX"
		))->setIngredient("X", Item::get(Item::STICK, 0, 4))->setIngredient("Y", Item::get(Item::WOODEN_PLANK, Planks::SPRUCE, 2)));
			
		$this->registerRecipe((new ShapedRecipe(Item::get(Item::FENCE_GATE_BIRCH, 0, 1),
			"   ",
			"XYX",
			"XYX"
		))->setIngredient("X", Item::get(Item::STICK, 0, 4))->setIngredient("Y", Item::get(Item::WOODEN_PLANK, Planks::BIRCH, 2)));
			
		$this->registerRecipe((new ShapedRecipe(Item::get(Item::FENCE_GATE_JUNGLE, 0, 1),
			"   ",
			"XYX",
			"XYX"
		))->setIngredient("X", Item::get(Item::STICK, 0, 4))->setIngredient("Y", Item::get(Item::WOODEN_PLANK, Planks::JUNGLE, 2)));
		
		$this->registerRecipe((new ShapedRecipe(Item::get(Item::FENCE_GATE_DARK_OAK, 0, 1),
			"   ",
			"XYX",
			"XYX"
		))->setIngredient("X", Item::get(Item::STICK, 0, 4))->setIngredient("Y", Item::get(Item::WOODEN_PLANK, Planks::DARK_OAK, 2)));
			
		$this->registerRecipe((new ShapedRecipe(Item::get(Item::FENCE_GATE_ACACIA, 0, 1),
			"   ",
			"XYX",
			"XYX"
		))->setIngredient("X", Item::get(Item::STICK, 0, 4))->setIngredient("Y", Item::get(Item::WOODEN_PLANK, Planks::ACACIA, 2)));
		
		$this->registerRecipe((new BigShapedRecipe(Item::get(Item::FURNACE, 0, 1),
			"XXX",
			"X X",
			"XXX"
		))->setIngredient("X", Item::get(Item::COBBLESTONE, 0, 8)));

		$this->registerRecipe((new BigShapedRecipe(Item::get(Item::WOODEN_DOOR, 0, 1),
			"XX ",
			"XX ",
			"XX "
		))->setIngredient("X", Item::get(Item::WOODEN_PLANK, "", 6)));
		...
		$this->registerRecipe((new BigShapedRecipe(Item::get(Item::MINECART, 0, 1),
			...
			"X X",
			"XXX"
		))->setIngredient("X", Item::get(Item::IRON_INGOT, 0, 5)));
		
		$this->registerRecipe((new BigShapedRecipe(Item::get(Item::BOOK, 0, 1),
			" X ",
			" X ",
			" XY"
		))->setIngredient("X", Item::get(Item::PAPER, 0, 3))->setIngredient("Y", Item::get(Item::LEATHER, 0, 1)));
		
		$this->registerRecipe((new BigShapedRecipe(Item::get(Item::BOOKSHELF, 0, 1),
			"XXX",
			"YYY",
			"XXX"
		))->setIngredient("X", Item::get(Item::WOODEN_PLANK, "", 6))->setIngredient("Y", Item::get(Item::BOOK, 0, 3)));

		$this->registerRecipe((new BigShapedRecipe(Item::get(Item::PAINTING, 0, 1),
			"XXX",
			"XYX",
			"XXX"
		))->setIngredient("X", Item::get(Item::STICK, 0, 8))->setIngredient("Y", Item::get(Item::WOOL, "", 1)));

		$this->registerRecipe((new ShapedRecipe(Item::get(Item::PAPER, 0, 3),
			"   ",
			"   ",
			"XXX"
		))->setIngredient("X", Item::get(Item::SUGARCANE, 0, 3)));

		$this->registerRecipe((new BigShapedRecipe(Item::get(Item::SIGN, 0, 3),
			"XXX",
			"XXX",
			" Y "
		))->setIngredient("Y", Item::get(Item::STICK, 0, 1))->setIngredient("X", Item::get(Item::WOODEN_PLANK, Planks::OAK, 6))); //TODO: check if it gives one sign or three

		$this->registerRecipe((new BigShapedRecipe(Item::get(Item::IRON_BARS, 0, 16),
			"   ",
			"XXX",
			"XXX"
		))->setIngredient("X", Item::get(Item::IRON_INGOT, 0, 6)));
	}
		...
		for($i = 1; $i < 2; ++$i){
			foreach($types[$i] as $j => $type){
				$this->registerRecipe((new BigShapedRecipe(Item::get($type, 0, 1),
					...
					" X ",
					" I "
				))->setIngredient("X", Item::get($types[0][$j], ""))->setIngredient("I", Item::get(Item::STICK)));
			}
		}
	...
	protected function registerTools(){
		...
		for($i = 1; $i < 5; ++$i){
			foreach($types[$i] as $j => $type){
				$this->registerRecipe((new BigShapedRecipe(Item::get($type, 0, 1), ...$shapes[$i - 1]))->setIngredient("X", Item::get($types[0][$j], ""))->setIngredient("I", Item::get(Item::STICK)));
			}
		}
