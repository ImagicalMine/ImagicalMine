...
class Level implements ChunkManager, Metadatable{
	...
	const REDSTONE_UPDATE_BLOCK = 5;
	const REDSTONE_UPDATE_BLOCK_CHARGE = 6;
	const REDSTONE_UPDATE_BLOCK_UNCHARGE = 7;
	const REDSTONE_UPDATE_LOSTPOWER = 8;
	const REDSTONE_UPDATE_BREAK = 9;
